...
const MODELS = [
  ...
  },
  {
    ...
    pctTax: 0.35,
    // % sobre produtos Corporate fora dos 2 "em destaque" escolhidos pelo franqueado no simulador
    // (pctCorporatePremium se aplica aos 2 selecionados) — ver produtosPremiumCount/platinumPremium.
    pctCorporate: 0.175,
    pctCorporatePremium: 0.35,
    produtosPremiumCount: 2,
    podeVenderFranquia: false,
    estrutura: 'Autônomo, podendo criar equipe interna',
    consultasPJ: 50,
    midiaMensal: 0,
    equipeDedicada: false,
    nota: '35% sobre Tax e sobre até 2 produtos Corporate escolhidos; 17,5% nos demais produtos Corporate.',
  },
  {
    id: 'CORPORATE',
    nome: 'CORPORATE',
  ...
  },
  {
    ...
    pctCorporate: 0.35,
    podeVenderFranquia: false,
    estrutura: 'Autônomo, podendo criar equipe interna — linha Studio Agro',
    consultasPJ: 50,
    midiaMensal: 0,
    equipeDedicada: false,
    nota: 'Linha Studio Agro: 35% de honorários em todas as soluções.',
  },
  {
    id: 'AGRO_PLATINUM',
